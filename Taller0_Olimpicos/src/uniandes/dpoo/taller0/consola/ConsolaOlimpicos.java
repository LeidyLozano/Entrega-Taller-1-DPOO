...
public class ConsolaOlimpicos
{
		...
		while (continuar)
		{
			try
			{
				...
				if (opcion_seleccionada == 1)
					...
					ejecutarNacionalidadPorAtletaDado();
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar nacionalidad de un atleta dado\n");
	...
	/**
	 * Le pide al usuario un nombre de un atleta y retorna el país de origen del
	 * atleta dado
	 */
	private void ejecutarNacionalidadPorAtletaDado()
	{
		System.out.println("\n" + "Nacionalidad de atleta específico" + "\n");
		String atletabuscado = input("Por favor ingrese el nombre de un atleta");
		
		Pais paisdelatleta = calculadora.NacionalidadPorAtletaDado(atletabuscado);
		
		System.out.println("La nacionalidad del atleta es  " + paisdelatleta.darNombre());
	}
	/**
